...
export default function GestaoHubPage() {
  return (
    <div className="min-h-screen text-white font-sans selection:bg-blue-500 selection:text-white relative overflow-x-hidden bg-black">
      ...
      {/* --- BOTÃO WHATSAPP --- */}
      <a href="https://wa.me/5511952835361" target="_blank" className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-xl z-50 transition-all hover:-translate-y-1 border border-white/10">
