                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="group relative bg-[#111111]/40 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex flex-col gap-6 hover:border-blue-500/40 transition-all duration-500">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed font-medium">Controle total da grade de horários de cada barbeiro. Personalize serviços e tempos de execução para cada profissional da sua equipe.</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-[#111111]/40 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex flex-col gap-6 hover:border-blue-500/40 transition-all duration-500">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed font-medium">Sem downloads chatos. Seu cliente acessa seu link exclusivo e reserva o horário em segundos, aumentando sua taxa de conversão.</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-[#111111]/40 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex flex-col gap-6 hover:border-blue-500/40 transition-all duration-500">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed font-medium">Link com sua logo e cores. Reduza o no-show enviando lembretes de confirmação profissionais diretamente para o WhatsApp do cliente.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer className="bg-black/80 backdrop-blur-xl py-12 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-600">
                    <div className="flex items-center gap-2 opacity-50">
                        ...
                        <span className="font-bold text-gray-400 uppercase tracking-widest">Kairós Arujá</span>
                    </div>
