                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="group relative bg-[#111111]/40 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex flex-col gap-6 hover:border-blue-500/40 transition-all duration-500">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed font-medium">Controle total sobre cada profissional do seu time. Horários, comissões e tempos de serviço organizados em agendas independentes e sincronizadas.</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-[#111111]/40 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex flex-col gap-6 hover:border-blue-500/40 transition-all duration-500">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed font-medium">Seu cliente de Campinas não precisa baixar nada. Ele acessa o link, escolhe o barbeiro e pronto. A reserva acontece em três cliques.</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-[#111111]/40 backdrop-blur-xl border border-white/10 p-10 rounded-[2.5rem] flex flex-col gap-6 hover:border-blue-500/40 transition-all duration-500">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-gray-400 text-base leading-relaxed font-medium">Personalização total com sua logo e cores. Confirmação de horário via WhatsApp de forma automática para reduzir as faltas na sua barbearia.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-6 bg-black/20">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        <GoogleReviewCard name="Marcia M." location="Cambuí" img="https://i.pravatar.cc/150?u=51" text="No Cambuí o pessoal é exigente. O link do Kairós passou um ar de barbearia premium e a agenda lotou rápido." />
                        <GoogleReviewCard name="Rafael C." location="Taquaral" img="https://i.pravatar.cc/150?u=52" text="O melhor sistema de Campinas. Meus clientes agendam sozinhos e eu recebo tudo pronto no painel. Praticidade total." />
                        <GoogleReviewCard name="Vinícius T." location="Barão Geraldo" img="https://i.pravatar.cc/150?u=53" text="O pessoal da Unicamp adora o agendamento sem app. Rápido, direto e sem burocracia de cadastro. Recomendo demais." />
                        <GoogleReviewCard name="Maria J." location="Nova Campinas" img="https://i.pravatar.cc/150?u=54" text="Sistema top. Reduzi o no-show enviando as confirmações pelo WhatsApp com um clique. Controle financeiro muito bom." />
                    </div>
                </div>
            </section>
            ...
            <footer className="bg-black/80 backdrop-blur-xl py-12 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-600">
                    <div className="flex items-center gap-2 opacity-50">
                        ...
                        <span className="font-bold text-gray-400 uppercase tracking-widest">Kairós Campinas</span>
                    </div>
