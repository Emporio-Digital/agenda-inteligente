...
// --- METADATA (SEO CIRÚRGICO PARA GUARULHOS) ---
export const metadata: Metadata = {
  title: "Sistema de Gestão para Barbearias em Guarulhos | Kairós Agendamentos",
  description: "O mais robusto sistema de gestão e agendamento em Guarulhos. Automação de agenda via WhatsApp, controle financeiro e gestão de equipe. Teste grátis!",
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-gray-400 text-[10px] uppercase font-bold tracking-tighter mt-1">Guarulhos • {location}</span>
        </div>
      </div>
      ...
      <main className="relative z-10">
        ...
        <section className="pt-40 pb-12 px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md text-blue-400 px-4 py-1.5 rounded-full text-xs font-bold uppercase border border-white/10 shadow-inner">
              📍 O SISTEMA DE AGENDAMENTO Nº 1 DE GUARULHOS
            </div>
            <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] text-white">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400">Guarulhos.</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
              Conecte sua barbearia à velocidade de quem não pode perder o voo. Automatize sua agenda com tecnologia de ponta em Guarulhos.
            </p>
            <Link href="/cadastro" className="inline-block bg-white text-black px-8 py-4 rounded-full text-lg font-bold shadow-2xl hover:-translate-y-1 transition-all">
              Modernizar minha Barbearia em Guarulhos 🚀
            </Link>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
            <div className="max-w-5xl mx-auto bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                <h2 className="text-2xl md:text-3xl font-black text-white mb-6 uppercase tracking-wide italic">Guarulhos exige agilidade: Da Paulo Faccini ao Aeroporto.</h2>
                <div className="space-y-4 text-gray-300 leading-relaxed text-sm md:text-base">
                    <p>
                        Para o barbeiro que comanda o movimento na badalada <strong className="text-blue-400">Avenida Paulo Faccini</strong> ou atende o público executivo da <strong className="text-blue-400">Vila Augusta</strong>, o tempo é o recurso mais escasso. Se o seu cliente precisa esperar você visualizar o WhatsApp entre um corte e outro perto do <strong className="text-blue-400">Bosque Maia</strong>, ele certamente já buscou outra opção na Tiradentes.
                    </p>
                    <p>
                        Atendendo não só o centro, mas também os barbeiros do <strong className="text-purple-400">Macedo, Pimentas e Bom Clima</strong>, o Kairós entende que a dinâmica de Guarulhos exige um agendamento instantâneo. Com o fluxo constante de passageiros e tripulantes que buscam serviços rápidos, sua barbearia precisa de um link que funcione em 3 cliques. O mercado em Guarulhos cresceu e a exigência por profissionalismo tecnológico é o que separa as barbearias de bairro das referências da cidade.
                    </p>
                </div>
            </div>
        </section>
                ...
                <details className="group bg-[#080b11]/80 backdrop-blur-xl border border-blue-900/30 rounded-2xl shadow-2xl overflow-hidden cursor-pointer">
                    <summary className="flex items-center justify-between p-6 md:p-8 outline-none hover:bg-white/[0.02] transition-colors">
                        <div className="flex items-center gap-4 md:gap-6">
                            ...
                            <div className="flex flex-col">
                                <h2 className="text-lg md:text-2xl font-bold uppercase tracking-wide text-white leading-tight">Dossiê de Dominação: Kairós em Guarulhos</h2>
                    ...
                    <div className="px-6 md:px-12 py-10 bg-[#030407] border-t border-white/5 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-gray-400 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-white uppercase flex items-center gap-2"><span className="inline-block w-1 h-5 bg-blue-500 rounded-full"></span> 1. SISTEMA DE GESTÃO PARA BARBEARIAS com link personalizado, logo e capa em Guarulhos.</h3>
                                <p className="mt-2">Tenha uma vitrine digital de elite para sua barbearia na Avenida Paulo Faccini com a identidade visual da sua marca estampada no link oficial. Esse posicionamento profissional economiza horas de atendimento, pois o cliente de Guarulhos já entende seu valor antes mesmo de agendar o corte. O Kairós permite customizar logo e capa, fugindo do visual genérico de outros softwares lentos e burocráticos de mercado. Eleve o padrão do seu negócio em Guarulhos e conquiste a confiança imediata do público que frequenta o Bosque Maia.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Organize seu time na Vila Augusta com calendários independentes e sincronizados em tempo real para cada barbeiro da sua equipe de especialistas. O benefício prático é a eliminação total de conflitos de horários, economizando cerca de 30 minutos diários de gestão manual estressante no seu negócio. Enquanto softwares antigos misturam tudo, o Kairós separa as cadeiras com clareza absoluta e interface intuitiva para o barbeiro de Guarulhos. Garanta uma operação fluida que reflete a qualidade técnica do seu time de profissionais guarulhenses.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Adapte seu cardápio de serviços para o público exigente do bairro Macedo, definindo durações e preços específicos conforme o nível de cada profissional. O controle total da sua margem de lucro em Guarulhos fica garantido com essa flexibilidade técnica que só o Kairós oferece no agendamento. Você altera valores instantaneamente no painel, sem precisar de suporte técnico demorado ou lidar com menus complicados de sistemas burocráticos. Domine o mercado de estética em Guarulhos oferecendo personalização real para cada tipo de cliente da cidade.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">O grande diferencial competitivo para o público de Guarulhos é a velocidade absoluta no acesso ao link de reserva sem nenhuma barreira técnica. Sabemos que o cliente que trabalha no Aeroporto ou mora no Pimentas não quer perder tempo baixando aplicativos pesados só para marcar um horário. Com o Kairós, o cliente entra, escolhe o barbeiro e pronto, sem burocracia de formulários longos ou senhas difíceis de lembrar. Essa facilidade garante que sua barbearia tenha uma taxa de conversão muito maior e atraia os melhores clientes da região.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Proporcione ao seu cliente do bairro Bom Clima a experiência de agendar um serviço completo com a mesma velocidade de um clique no Instagram. A agilidade extrema do sistema libera sua recepção para focar 100% no atendimento presencial de alto nível aos clientes que já estão na cadeira. Enquanto a concorrência se perde em áudios longos de WhatsApp, seu cliente em Guarulhos resolve a vida de forma autônoma e muito rápida. Mostre que sua barbearia respeita o tempo do cliente com a tecnologia de agendamento mais veloz de Guarulhos.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Elimine o erro humano e os furos na agenda da sua unidade no bairro Cocaia com nosso algoritmo de sincronização em tempo real. O sistema economiza o estresse de ter dois clientes marcados para o mesmo barbeiro no mesmo horário de pico da sua barbearia em Guarulhos. Ao contrário de agendas de papel que falham, o Kairós trava o horário no milissegundo em que o agendamento ocorre no link oficial da barbearia. Mantenha a organização impecável e evite qualquer tipo de reclamação por atrasos ou falhas operacionais na Grande São Paulo.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Humanize o atendimento da sua barbearia em Guarulhos permitindo que o cliente escolha visualmente o profissional que mais combina com seu estilo. Isso gera uma conexão imediata e aumenta a confiança do cliente antes mesmo dele chegar ao seu estabelecimento físico próximo à Rodovia Presidente Dutra. O Kairós entende que o visual é fundamental no nicho de beleza, por isso destacamos a foto do barbeiro com qualidade superior. Fortaleça a marca pessoal dos seus profissionais e fidelize o público de Guarulhos com uma interface moderna.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Facilite a rotina da sua equipe no bairro Taboão com um painel de controle que não exige treinamentos complexos ou manuais extensos de uso. Seus barbeiros visualizam o próximo atendimento do dia em segundos pelo celular, otimizando o fluxo de trabalho dentro da sua barbearia em Guarulhos. O Kairós remove todas as distrações visuais e botões inúteis que apenas poluem softwares tradicionais de gestão de negócios. Garanta que sua operação em Guarulhos seja fluida e que seus colaboradores amem utilizar a tecnologia de ponta que você oferece.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Tenha o controle total do seu faturamento e da agenda em Guarulhos na palma da mão, acessando o sistema com um único toque rápido. Economize tempo precioso abrindo a gestão instantaneamente sem precisar digitar endereços de sites ou buscar em abas perdidas do seu navegador móvel. O Kairós funciona com tecnologia PWA, sendo muito mais leve e rápido do que aplicativos nativos que costumam travar no celular. Esteja sempre presente na gestão do seu negócio em Guarulhos, monitorando o crescimento de onde você estiver na cidade.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Saiba exatamente quais são os serviços que mais rendem na sua barbearia em Guarulhos e identifique quem são os seus clientes mais fiéis do Jardim Maia. O benefício prático é poder criar estratégias de marketing cirúrgicas para quem não aparece há algum tempo na sua loja física próxima à Avenida Tiradentes. Diferente de outros sistemas que escondem seus dados, o Kairós entrega relatórios financeiros claros e intuitivos para o dono. Tome decisões baseadas em números reais e impulsione o crescimento da sua barbearia em Guarulhos com segurança.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Reduza as faltas e o esquecimento de clientes na sua barbearia no bairro Ponte Grande enviando lembretes profissionais de agendamento de forma simplificada. Essa funcionalidade diminui o No-Show em até 40%, protegendo seu faturamento diário em Guarulhos contra imprevistos de última hora dos clientes. O Kairós automatiza o processo: você clica na reserva e a mensagem de confirmação já sai pronta para ser disparada pelo WhatsApp. Profissionalize sua comunicação em Guarulhos e mantenha sua agenda sempre cheia e confirmada com máxima eficiência.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-white uppercase flex items-center gap-2"><span className="inline-block w-1 h-5 bg-blue-500 rounded-full"></span> 12. SISTEMA DE GESTÃO PARA BARBEARIAS focado em experiência Mobile-First para clientes de Guarulhos.</h3>
                                <p className="mt-2">Otimizamos cada pixel do sistema para que seu cliente de Guarulhos tenha rapidez total ao agendar pelo smartphone enquanto se desloca pela Rodovia Fernão Dias. O benefício é uma interface que carrega instantaneamente, mesmo em conexões de internet 4G instáveis dentro dos bairros da cidade. Enquanto softwares antigos travam no celular, o Kairós foi desenhado primeiro para a tela pequena, garantindo satisfação total do seu público. Ofereça a melhor e mais moderna experiência de agendamento mobile de Guarulhos aos seus clientes exigentes.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Pare de perder horas respondendo "quais horários você tem?" na sua barbearia em Guarulhos e deixe a tecnologia trabalhar por você 24 horas por dia. Automatizar a agenda permite que você e sua equipe foquem 100% na qualidade do corte e na experiência do cliente que já está na cadeira. O Kairós é a solução definitiva contra a burocracia de áudios e textos infinitos que travam a produtividade do seu negócio em Guarulhos. Recupere sua paz mental deixando o sistema gerenciar as reservas com total perfeição e autonomia total.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2">Tenha uma visão clara e organizada do fluxo de caixa da sua barbearia na Vila Rio com filtros financeiros precisos e fáceis de ler no painel. Controle seu faturamento bruto e analise a produtividade da sua equipe mês a mês sem a necessidade de planilhas de Excel confusas ou manuais de gestão. O diferencial do Kairós é traduzir números brutos em informações estratégicas para o dono da barbearia planejar o futuro em Guarulhos. Mantenha as finanças do seu negócio sob controle total com relatórios intuitivos e seguros para sua gestão.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-white uppercase flex items-center gap-2"><span className="inline-block w-1 h-5 bg-blue-500 rounded-full"></span> 15. SISTEMA DE GESTÃO PARA BARBEARIAS para modernizar e profissionalizar o seu negócio em Guarulhos.</h3>
                                <p className="mt-2">Eleve sua barbearia ao patamar de excelência que o público de Guarulhos exige e seja reconhecido como a referência tecnológica do seu bairro. O ganho de autoridade local é imediato quando os clientes percebem que você utiliza um sistema de gestão de elite para organizar sua agenda. O Kairós remove definitivamente o amadorismo das anotações em papel e coloca sua barbearia na era da automação digital completa na cidade de Guarulhos. Seja o líder de mercado na sua região e veja sua base de clientes crescer com a força da nossa tecnologia.</p>
                            </div>
        ...
        <section className="py-24 px-6 bg-black/20">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                  <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-tight">Barbeiros que dominam Guarulhos:</h2>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                  <GoogleReviewCard name="Tatiana M." location="Bosque Maia" img="https://i.pravatar.cc/150?u=101" text="Minha barbearia perto do Bosque Maia mudou da água pro vinho. O agendamento é rápido e profissional como o bairro exige." />
                  <GoogleReviewCard name="Leandro P." location="Paulo Faccini" img="https://i.pravatar.cc/150?u=102" text="Na Paulo Faccini a concorrência é forte. O link do Kairós me deu a agilidade que eu precisava pra não perder nenhum cliente." />
                  <GoogleReviewCard name="Fernanda S." location="Vila Augusta" img="https://i.pravatar.cc/150?u=103" text="O financeiro do Kairós é excelente. Consigo controlar minha unidade na Vila Augusta direto pelo celular sem complicação." />
                  <GoogleReviewCard name="Tiago G." location="Aeroporto" img="https://i.pravatar.cc/150?u=104" text="Atendo muito pessoal do Aeroporto e eles amam a velocidade do link. Agendou, confirmou, cortou. Simples e direto." />
                </div>
            </div>
        </section>
        ...
        <section className="py-24 border-t border-white/5">
            <div className="max-w-4xl mx-auto px-6 text-center">
                <h2 className="text-3xl md:text-4xl font-black text-white mb-6 uppercase italic">Sua barbearia em Guarulhos na tela do celular</h2>
        ...
        <footer className="bg-black/80 backdrop-blur-xl py-12 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-600">
            <div className="flex items-center gap-2 opacity-50">
              ...
              <span className="font-bold text-gray-400 uppercase tracking-widest">Kairós Guarulhos</span>
            </div>
