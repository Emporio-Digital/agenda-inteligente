            ...
            <section className="pt-32 md:pt-40 pb-12 px-6 relative">
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-600 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide border border-blue-200/80 shadow-sm">
                        <span>📍</span>
                        <span>O SISTEMA DE AGENDAMENTO Nº 1 DO CARRÃO</span>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 italic tracking-tighter uppercase leading-tight">
                            Barbeiros que dominam o <span className="text-blue-600">Carrão:</span>
                        </h2>
            ...
            <section className="py-24 bg-slate-100/60 border-t border-slate-200/80 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 uppercase italic">
                        Sua barbearia no Carrão na tela do celular
                    </h2>
                    ...
                    <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                        <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                            <span className="flex items-center gap-4 md:gap-6">
                                ...
                                <span className="flex flex-col text-left">
                                    <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-blue-600 transition-colors">Dossiê de Dominação: Kairós no Carrão</span>
                        ...
                        <div className="py-8 md:py-12 relative">
                            <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                                ...
                                <div>
                                    <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-blue-500 rounded-full inline-block"></span> 1. SISTEMA DE GESTÃO PARA BARBEARIAS com link personalizado, logo e capa no Carrão.</h3>
                                    <p className="mt-2 text-left text-slate-600">Reforce a identidade da sua barbearia na Conselheiro Carrão com um link de agendamento que é uma extensão da sua vitrine. O benefício prático é a construção de uma marca sólida que passa confiança imediata para o cliente exigente da Zona Leste. Enquanto sistemas baratos são genéricos, o Kairós valoriza sua logomarca e fotos, transformando cliques em atendimentos reais. Destaque-se na vizinhança com uma presença digital profissional e de alto nível.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-left text-slate-600">O maior diferencial do nosso sistema para o público do Carrão é a ausência total de barreiras técnicas para agendar. Sabemos que o morador da Zona Leste odeia perder tempo criando senhas ou baixando aplicativos pesados que travam o celular. Com o Kairós, seu cliente entra no link, clica no serviço e já está agendado, sem burocracia alguma. Essa facilidade de uso garante que sua taxa de conversão seja drasticamente superior à da concorrência local.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-left text-slate-600">Ofereça ao seu cliente do Carrão a conveniência de marcar um corte de cabelo em menos de 60 segundos. Esse ganho de agilidade permite que você foque no atendimento presencial enquanto sua agenda se preenche sozinha no piloto automático. Enquanto outros sistemas pedem dados desnecessários, o Kairós foca no que importa: a reserva da vaga na sua cadeira. Mostre que sua barbearia é a mais eficiente do bairro e conquiste a fidelidade pelo respeito ao tempo do cliente.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-left text-slate-600">Reduza em até 40% as faltas dos seus clientes no Carrão com nosso sistema de confirmação rápida via WhatsApp. O benefício direto é a proteção do seu caixa diário contra esquecimentos de clientes que deixam de comparecer. Com o Kairós, você não precisa digitar nada: basta clicar no ícone e a mensagem profissional já vai pronta para o celular do cliente. Garanta que sua agenda esteja sempre confirmada e evite buracos no faturamento por conta de "no-shows" evitáveis.</p>
                                </div>

                                <div>
                                    <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-blue-500 rounded-full inline-block"></span> 12. SISTEMA DE GESTÃO PARA BARBEARIAS focado em experiência Mobile-First para clientes do Carrão.</h3>
                                    <p className="mt-2 text-left text-slate-600">Proporcione a melhor experiência de agendamento pelo celular para o público do Carrão, com uma interface que carrega instantaneamente. O benefício é evitar que o cliente desista de agendar por causa de sites lentos ou botões que não funcionam no smartphone. O Kairós foi projetado para rodar perfeitamente mesmo em conexões 4G instáveis, garantindo que o agendamento seja concluído em qualquer lugar. Seja referência em tecnologia mobile na Zona Leste e fidelize os clientes que buscam praticidade máxima.</p>
                                </div>
