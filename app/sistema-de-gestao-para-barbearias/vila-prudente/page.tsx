...
// --- METADATA (SEO CIRÚRGICO PARA VILA PRUDENTE) ---
    ...
    <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-gray-400 text-[10px] uppercase font-bold tracking-tighter mt-1">Vila Prudente • {location}</span>
            </div>
        </div>
        ...
        <main className="relative z-10">
            ...
            <section className="pt-40 pb-12 px-6 text-center">
                <div className="max-w-4xl mx-auto space-y-8">
                    <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md text-blue-400 px-4 py-1.5 rounded-full text-xs font-bold uppercase border border-white/10 shadow-inner">
                        📍 O SISTEMA DE AGENDAMENTO Nº 1 DE VILA PRUDENTE
                    </div>
                    <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] text-white">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400">Vila Prudente.</span>
                    </h1>
                    <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
                        Transforme a gestão da sua barbearia com a tecnologia que mais cresce na Zona Leste. Agendamento em 1 minuto sem burocracia para o seu cliente.
                    </p>
                    <Link href="/cadastro" className="inline-block bg-white text-black px-8 py-4 rounded-full text-lg font-bold shadow-2xl hover:-translate-y-1 transition-all">
                        Modernizar minha Barbearia na Vila Prudente 🚀
                    </Link>
                </div>
            </section>
            ...
            <section className="py-12 px-6">
                <div className="max-w-5xl mx-auto bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    <h2 className="text-2xl md:text-3xl font-black text-white mb-6 uppercase tracking-wide italic">A Vila Prudente não para, sua barbearia também não pode parar.</h2>
                    <div className="space-y-4 text-gray-300 leading-relaxed text-sm md:text-base">
                        <p>
                            Para quem comanda uma barbearia na <strong className="text-blue-400">Avenida Paes de Barros</strong> ou nas imediações do <strong className="text-blue-400">Metrô Vila Prudente</strong>, o tempo é ouro. O fluxo constante de pessoas entre o <strong className="text-blue-400">Jardim Avelino</strong> e a Mooca exige que sua barbearia seja rápida no digital. Se o seu cliente ainda precisa esperar você responder no WhatsApp para marcar um corte, ele já buscou o concorrente na rua ao lado.
                        </p>
                        <p>
                            Atendendo não só o centro do bairro, mas também as barbearias da <strong className="text-purple-400">Rua do Orfanato, Avenida Vila Ema e Parque da Vila Prudente</strong>, o Kairós foi desenhado para quem quer profissionalismo extremo. O mercado local está cada vez mais sofisticado e o público da Vila Prudente busca conveniência. Nosso sistema garante que seu faturamento aumente enquanto você foca no que realmente importa: a arte da barbearia.
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section className="py-24 px-6 relative overflow-hidden">
                    ...
                    <details className="group bg-[#080b11]/80 backdrop-blur-xl border border-blue-900/30 rounded-2xl shadow-2xl overflow-hidden cursor-pointer">
                        <summary className="flex items-center justify-between p-6 md:p-8 outline-none hover:bg-white/[0.02] transition-colors">
                            <div className="flex items-center gap-4 md:gap-6">
                                ...
                                <div className="flex flex-col">
                                    <h2 className="text-lg md:text-2xl font-bold uppercase tracking-wide text-white leading-tight">Dossiê de Dominação: Kairós na Vila Prudente</h2>
                        ...
                        <div className="px-6 md:px-12 py-10 bg-[#030407] border-t border-white/5 relative">
                            <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-gray-400 text-sm md:text-base leading-relaxed">
                                ...
                                <div>
                                    <h3 className="font-bold text-white uppercase flex items-center gap-2"><div className="w-1 h-5 bg-blue-500 rounded-full"></div> 1. SISTEMA DE GESTÃO PARA BARBEARIAS com link personalizado, logo e capa na Vila Prudente.</h3>
                                    <p className="mt-2">Crie uma vitrine digital de alto padrão para sua barbearia no Jardim Avelino com um link que é a cara do seu negócio. Essa personalização gera uma autoridade imediata, mostrando para o público da Vila Prudente que você investe na experiência do cliente. Enquanto sistemas comuns são genéricos e confusos, o Kairós destaca sua marca com elegância e clareza visual. Garanta que sua barbearia seja lembrada pela modernidade desde o primeiro contato digital.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Organize seu time de barbeiros na Avenida Vila Ema com calendários exclusivos e sincronização automática em tempo real. O benefício prático é eliminar o caos na recepção e economizar 30 minutos diários conferindo horários de cada colaborador. Diferente de agendas de papel que se perdem, o Kairós separa as responsabilidades com precisão total e facilidade de leitura. Eleve a produtividade da sua barbearia na Vila Prudente e deixe sua equipe focar apenas no atendimento de qualidade.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Defina preços e tempos de execução específicos para cada serviço na sua unidade da Rua do Orfanato, garantindo controle total do lucro. A flexibilidade do sistema permite ajustar seu cardápio de serviços de acordo com a demanda exclusiva do público da Vila Prudente. Enquanto outros softwares são engessados, o Kairós permite mudanças rápidas sem burocracia ou suporte técnico demorado. Domine o mercado local oferecendo um agendamento que reflete exatamente a realidade comercial do seu negócio.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">O grande diferencial do Kairós para o público que circula pelo Metrô Vila Prudente é a velocidade de agendar sem criar contas. Ninguém quer perder tempo preenchendo formulários ou baixando aplicativos que ocupam espaço no celular só para um corte. Com nosso sistema, o cliente escolhe o horário e finaliza em segundos, garantindo uma taxa de conversão muito maior. Essa facilidade faz com que sua barbearia na Zona Leste tenha um fluxo de agendamentos muito mais intenso e fluido.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Permita que seu cliente da Avenida Paes de Barros agende o serviço em menos de 60 segundos, com apenas três cliques rápidos. Essa agilidade absurda libera sua recepção de atender chamadas constantes e focar no acolhimento presencial de quem já está na loja. Enquanto a concorrência se perde em áudios longos de WhatsApp, sua barbearia na Vila Prudente fatura de forma automática. Mostre que seu negócio respeita o tempo do cliente e se destaque como a barbearia mais eficiente da região.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Elimine o pesadelo de marcar dois clientes no mesmo horário na sua barbearia na Vila Prudente com nossa tecnologia de trava automática. O benefício é a paz mental de saber que sua agenda está sempre organizada e livre de erros humanos que causam atrasos. O Kairós sincroniza as informações no milissegundo em que o agendamento ocorre, bloqueando o horário para outros usuários. Mantenha a reputação da sua barbearia impecável e evite qualquer tipo de desconforto com seus clientes fidelizados.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Humanize o atendimento da sua barbearia na Vila Prudente permitindo que o cliente selecione o profissional visualizando sua foto real. Isso gera uma conexão imediata e aumenta a segurança do cliente que busca um estilo específico na Zona Leste. O Kairós entende que em São Paulo a imagem é tudo, por isso valorizamos a marca pessoal dos seus barbeiros. Transforme seu agendamento em uma experiência visual moderna e atrativa que converte muito mais que uma lista de nomes fria.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Facilite a vida do seu time na Vila Prudente com um painel de controle que dispensa treinamentos chatos ou manuais de uso. Seus barbeiros visualizam o próximo serviço em segundos, otimizando o ritmo de trabalho e a limpeza das cadeiras. O Kairós foi projetado para ser prático, eliminando menus complexos que apenas atrapalham o uso diário em barbearias de alto fluxo. Garanta que sua equipe foque 100% na técnica e no bom papo com o cliente, enquanto o sistema cuida da organização.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Tenha o controle financeiro e a agenda da sua barbearia na Vila Prudente a um toque de distância, de onde você estiver. Economize tempo precioso acessando o sistema instantaneamente como se fosse um aplicativo nativo, mas com a leveza do navegador. O Kairós permite que você monitore o movimento da loja enquanto se desloca pela Paes de Barros ou está em um compromisso externo. Esteja sempre no comando do seu negócio com a tecnologia que acompanha a rotina de um dono de barbearia de sucesso.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Saiba exatamente quais são os serviços que mais trazem lucro para sua barbearia na Vila Prudente e entenda o perfil dos seus clientes. O benefício é poder criar estratégias de fidelização baseadas em dados reais de consumo e frequência de cada pessoa. Diferente de sistemas burocráticos, o Kairós entrega relatórios limpos e fáceis de analisar em poucos segundos. Tome decisões inteligentes para o futuro da sua barbearia na Zona Leste com base em informações sólidas e não em achismos.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Reduza em até 40% o No-Show na sua barbearia na Vila Prudente enviando lembretes de confirmação rápidos para seus clientes. Essa funcionalidade recupera o faturamento que seria perdido por esquecimento, garantindo que suas cadeiras estejam sempre ocupadas. O Kairós simplifica o processo: basta um clique e a mensagem já vai pronta com o horário e o barbeiro escolhido. Profissionalize sua comunicação no Tatuapé e região e mantenha sua agenda sempre cheia e lucrativa todos os dias.</p>
                                </div>

                                <div>
                                    <h3 className="font-bold text-white uppercase flex items-center gap-2"><div className="w-1 h-5 bg-blue-500 rounded-full"></div> 12. SISTEMA DE GESTÃO PARA BARBEARIAS focado em experiência Mobile-First para clientes de Vila Prudente.</h3>
                                    <p className="mt-2">Ofereça uma plataforma de agendamento que voa no celular do seu cliente, otimizada para quem busca rapidez em São Paulo. O benefício é uma interface limpa que carrega instantaneamente, mesmo em conexões 4G instáveis comuns nos bairros. Enquanto softwares antigos são pesados e difíceis de usar no mobile, o Kairós foi desenhado para ser o mais rápido do mercado. Ganhe a preferência do público da Vila Prudente oferecendo a melhor jornada de agendamento digital da região.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Pare de perder horas do seu dia respondendo disponibilidade de horários na sua barbearia da Vila Prudente e automatize esse processo. Centralizar os pedidos no link do Kairós permite que você e sua equipe foquem totalmente no corte e no atendimento de excelência. O sistema é o antídoto contra a burocracia de textos infinitos e áudios que tiram sua produtividade durante o expediente. Recupere sua paz mental na Zona Leste deixando o Kairós gerenciar suas reservas 24 horas por dia.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-2">Tenha uma visão transparente das finanças da sua barbearia na Vila Prudente com filtros que mostram o crescimento real do seu faturamento. Controle entradas, saídas e comissões de forma organizada sem precisar de planilhas de Excel complexas e confusas. O diferencial do Kairós é a simplicidade operacional que entrega dados estratégicos para você investir na sua loja com segurança. Mantenha o fluxo de caixa da sua barbearia na Zona Leste sob controle total com relatórios intuitivos e seguros.</p>
                                </div>

                                <div>
                                    <h3 className="font-bold text-white uppercase flex items-center gap-2"><div className="w-1 h-5 bg-blue-500 rounded-full"></div> 15. SISTEMA DE GESTÃO PARA BARBEARIAS para modernizar e profissionalizar o seu negócio em Vila Prudente.</h3>
                                    <p className="mt-2">Eleve o nível da sua barbearia e seja reconhecido como o estabelecimento mais tecnológico e organizado da Vila Prudente. O ganho de autoridade local é imediato quando os clientes percebem que você utiliza um sistema de gestão de elite para atendê-los. O Kairós elimina o amadorismo das anotações em papel e coloca sua barbearia na era da automação digital completa. Seja a referência de modernidade no seu bairro em São Paulo e conquiste os clientes mais exigentes da capital paulista.</p>
                                </div>
            ...
            <section className="py-24 px-6 bg-black/20">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                        <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-tight">Barbeiros que dominam a Vila Prudente:</h2>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        <GoogleReviewCard name="Vitoria G." location="Paes de Barros" img="https://i.pravatar.cc/150?u=31" text="Minha barbearia na Paes de Barros mudou de nível. O agendamento é rápido e os clientes do Jardim Avelino adoraram a praticidade." />
                        <GoogleReviewCard name="Julia L." location="Metrô Vila Prudente" img="https://i.pravatar.cc/150?u=32" text="Perto do metrô o movimento é frenético. O Kairós organiza tudo sem eu precisar encostar no celular. O melhor sistema de SP." />
                        <GoogleReviewCard name="Bruno P." location="Jardim Avelino" img="https://i.pravatar.cc/150?u=33" text="Interface limpa e profissional. Passa muita confiança para o cliente premium da região. Controle financeiro nota 10." />
                        <GoogleReviewCard name="Thiago K." location="Vila Ema" img="https://i.pravatar.cc/150?u=34" text="Reduzi o vai-e-vem no WhatsApp em 90%. Agora foco só no corte aqui na Vila Ema. Sistema essencial pra quem quer crescer." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 border-t border-white/5">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-black text-white mb-6 uppercase italic">Sua barbearia na Vila Prudente na tela do celular</h2>
            ...
            <footer className="bg-black/80 backdrop-blur-xl py-12 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-600">
                    <div className="flex items-center gap-2 opacity-50">
                        ...
                        <span className="font-bold text-gray-400 uppercase tracking-widest">Kairós Vila Prudente</span>
                    </div>
