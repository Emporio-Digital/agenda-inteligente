      ...
      <div className="fixed top-0 left-0 w-full z-50">
        ...
        <header className="w-full bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-6 py-2.5 md:py-3 shadow-sm">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            {/* LADO DIREITO DESKTOP (VISÍVEL APENAS MD PRA CIMA) */}
            ...
            {/* LADO DIREITO MOBILE: BOTÃO HAMBURGUER IDÊNTICO AO SISTEMA */}
            <label 
        ...
        {/* GAVETA DESLIZANTE NO MOBILE (COM OS DOIS BOTÕES) */}
      ...
      <main className="relative z-10">
        ...
        <section className="pt-32 md:pt-40 pb-12 px-6 relative">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            {/* CARD DE VIDRO (ACRÍLICO REAL COM BISEL INTERNO) */}
            <div className="max-w-3xl mx-auto mt-6 p-[1px] rounded-2xl bg-gradient-to-r from-blue-500/10 via-blue-500/40 to-blue-500/10 shadow-[0_10px_30px_-5px_rgba(37,99,235,0.15)]">
              <div className="bg-white/60 backdrop-blur-2xl border border-white/90 rounded-2xl p-6 text-center shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_12px_28px_-8px_rgba(15,23,42,0.1)]">
                  <p className="text-slate-700 text-sm md:text-base leading-relaxed font-medium">
                      O <strong className="text-slate-900">Kairós</strong> é a solução definitiva de <strong className="text-slate-900">agendamento online</strong>. 
            ...
            <div className="w-full overflow-hidden py-8 border-y border-white/80 bg-white/40 backdrop-blur-xl shadow-[inset_0_1px_1px_rgba(255,255,255,1)] mt-8 hover-pause">
              <div className="flex w-[200%] animate-scroll">
                {[1, 2].map((i) => (
                  <div key={i} className="flex gap-8 px-4 whitespace-nowrap">
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">💈 Barbearia</div>
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">💅 Salão de Beleza</div>
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">🍽️ Restaurantes</div>
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">🏥 Clínica / Saúde</div>
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">🐉 Tattoo Studio</div>
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">📸 Fotografia</div>
                    <div className="flex items-center gap-2 text-slate-800 font-bold text-lg px-6 py-2">💼 Serviços</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-8">
              <Link href="/cadastro" className="w-full md:w-auto bg-blue-600 text-white px-8 py-4 rounded-full text-lg font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/35 hover:-translate-y-1 flex items-center justify-center gap-2">
                Começar Agora 🚀
              </Link>
            </div>
    ...
    <div className="flex flex-col lg:flex-row items-center gap-16">
      ...
      <div className="flex-1 relative">
        ...
        <section className="py-24 px-6 relative">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-slate-900">Planos que crescem com você</h2>
              <p className="text-slate-600">Comece pequeno, termine gigante.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {/* SOLO */}
              <div className="border border-white/90 bg-white/70 backdrop-blur-2xl rounded-3xl p-8 shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_12px_28px_-8px_rgba(15,23,42,0.08)] hover:shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_18px_32px_-8px_rgba(15,23,42,0.12)] transition-all hover:-translate-y-1">
                <h3 className="font-bold text-slate-500 uppercase tracking-widest text-sm mb-2">Solo</h3>
                <div className="text-4xl font-black mb-4 text-slate-900">R$ 49,90<span className="text-lg text-slate-500 font-medium">/mês</span></div>
                <p className="text-sm text-slate-500 mb-8 border-b border-slate-200/60 pb-8">Ideal para autônomos que querem organização.</p>
                <ul className="space-y-3 mb-8 text-sm text-slate-600">
                  <li className="flex gap-2">✅ 1 Profissional</li>
                  <li className="flex gap-2">✅ Agendamentos Ilimitados</li>
                </ul>
                <Link href="/cadastro" className="block w-full py-3 rounded-xl border border-slate-200 bg-white/80 hover:bg-white text-slate-800 font-bold text-center hover:border-slate-300 transition-all shadow-sm">
                  Testar Grátis
                </Link>
              </div>

              {/* PRO */}
              <div className="border-2 border-blue-600/90 bg-white/85 backdrop-blur-2xl rounded-3xl p-8 relative shadow-[inset_0_2px_1px_rgba(255,255,255,1),0_20px_40px_-10px_rgba(37,99,235,0.22)] transform md:-translate-y-4 hover:shadow-[inset_0_2px_1px_rgba(255,255,255,1),0_25px_50px_-10px_rgba(37,99,235,0.28)] transition-all overflow-hidden">
                <div className="absolute top-0 right-0 bg-blue-600 text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl uppercase tracking-widest shadow-sm">Recomendado</div>
                <h3 className="font-bold text-blue-600 uppercase tracking-widest text-sm mb-2">Pró</h3>
                <div className="text-4xl font-black mb-4 text-slate-900">R$ 119,90<span className="text-lg text-slate-500 font-medium">/mês</span></div>
                <p className="text-sm text-slate-500 mb-8 border-b border-slate-200/60 pb-8">Para negócios com equipe em crescimento.</p>
                <ul className="space-y-3 mb-8 text-sm text-slate-800 font-medium">
                ...
                <Link href="/cadastro" className="block w-full py-3 rounded-xl bg-blue-600 text-white font-bold text-center hover:bg-blue-700 transition-all shadow-md shadow-blue-500/25">
                  Testar Grátis Agora
                </Link>
              </div>
              ...
              {/* ILIMITADO */}
              <div className="border border-white/90 bg-white/70 backdrop-blur-2xl rounded-3xl p-8 shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_12px_28px_-8px_rgba(15,23,42,0.08)] hover:shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_18px_32px_-8px_rgba(15,23,42,0.12)] transition-all hover:-translate-y-1">
                <h3 className="font-bold text-slate-500 uppercase tracking-widest text-sm mb-2">Ilimitado</h3>
                <div className="text-4xl font-black mb-4 text-slate-900">R$ 229,90<span className="text-lg text-slate-500 font-medium">/mês</span></div>
                <p className="text-sm text-slate-500 mb-8 border-b border-slate-200/60 pb-8">Para grandes redes e franquias. Sem limites.</p>
                <ul className="space-y-3 mb-8 text-sm text-slate-600">
            ...
            <p className="text-center text-xs text-slate-500 mt-8">* Valores referentes ao plano mensal.</p>
          </div>
        </section>
        ...
        <section className="py-24 border-t border-slate-200/80">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-slate-900">Onde divulgar seu link?</h2>
              <p className="text-slate-500">Três lugares estratégicos para encher sua agenda sem esforço.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/70 backdrop-blur-2xl p-8 rounded-2xl border border-white/90 text-center shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_12px_28px_-8px_rgba(15,23,42,0.08)] hover:border-pink-300 hover:shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_20px_35px_-8px_rgba(244,114,182,0.22)] transition-all group hover:-translate-y-2">
                <div className="w-12 h-12 bg-pink-50/90 text-pink-600 border border-pink-200/80 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl group-hover:scale-110 transition-transform shadow-sm">🔗</div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Link na Bio (Instagram)</h3>
                <p className="text-sm text-slate-600">Coloque seu link Kairós na Bio do Instagram ou TikTok. Seu cliente entra no perfil e agenda sozinho.</p>
              </div>

              <div className="bg-white/70 backdrop-blur-2xl p-8 rounded-2xl border border-white/90 text-center shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_12px_28px_-8px_rgba(15,23,42,0.08)] hover:border-green-300 hover:shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_20px_35px_-8px_rgba(34,197,94,0.22)] transition-all group hover:-translate-y-2">
                <div className="w-12 h-12 bg-green-50/90 text-green-600 border border-green-200/80 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl group-hover:scale-110 transition-transform shadow-sm">💬</div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Resposta Automática</h3>
                <p className="text-sm text-slate-600">No WhatsApp Business, crie uma saudação automática: "Olá! Para agendar, clique aqui: [Seu Link]".</p>
              </div>

              <div className="bg-white/70 backdrop-blur-2xl p-8 rounded-2xl border border-white/90 text-center shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_12px_28px_-8px_rgba(15,23,42,0.08)] hover:border-blue-300 hover:shadow-[inset_0_1.5px_1px_rgba(255,255,255,1),0_20px_35px_-8px_rgba(59,130,246,0.22)] transition-all group hover:-translate-y-2">
                <div className="w-12 h-12 bg-blue-50/90 text-blue-600 border border-blue-200/80 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl group-hover:scale-110 transition-transform shadow-sm">📍</div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Botão do Google</h3>
                <p className="text-sm text-slate-600">Tem ficha no Google Maps? Adicione seu link no botão "Agendar". Apareça para quem busca na sua região.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
                <details className="group bg-white/70 backdrop-blur-2xl border border-white/90 rounded-2xl overflow-hidden cursor-pointer shadow-[inset_0_1px_1px_rgba(255,255,255,1),0_8px_20px_-6px_rgba(15,23,42,0.06)] hover:border-blue-300/80 transition-all">
                    <summary className="flex justify-between items-center p-5 font-semibold text-slate-800 hover:text-blue-600 transition-colors select-none">
                        Para qual tipo de negócio o sistema serve?
                        <span className="transform group-open:rotate-180 transition-transform text-xs text-slate-400 group-hover:text-blue-600">▼</span>
                    </summary>
                    <div className="px-5 pb-5 text-sm text-slate-600 border-t border-slate-200/60 pt-3 text-left leading-relaxed">
        ...
        <section className="py-24 bg-slate-100/60 border-t border-slate-200/80 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">Tenha o Kairós como App no seu celular</h2>
                ...
                {/* DOCK DE VIDRO EXTERNO ENVOLVENDO O CELULAR */}
        ...
        <section className="py-24 px-6 relative z-20">
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            ...
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-blue-600 transition-colors">Sistema de Gestão para Barbearias</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">Autoridade máxima em agendamento para barbeiros</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-blue-500 rounded-full inline-block"></span> 1. SISTEMA DE GESTÃO PARA BARBEARIAS com link personalizado, logo e capa exclusivos.</h3>
                                <p className="mt-2 text-left text-slate-600">Eleve o nível profissional da sua marca com uma vitrine digital de alto padrão que centraliza todos os seus atendimentos em um único lugar. O diferencial estratégico do Kairós é permitir que sua identidade visual seja a protagonista, gerando confiança imediata no momento da reserva. Enquanto outros sistemas oferecem páginas genéricas e frias, nós entregamos uma experiência imersiva que valoriza cada detalhe do seu negócio. Garanta que seu link de agendamento seja a ferramenta de conversão mais potente da sua barbearia hoje.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-left text-slate-600">Tenha controle total sobre o seu cardápio de serviços, ajustando preços e durações de acordo com a especialidade de cada barbeiro da sua unidade. A flexibilidade do Kairós permite que você configure combos, barboterapia ou cortes técnicos com precisão absoluta para o seu público-alvo. Essa personalização detalhada reflete a realidade do seu faturamento e evita buracos ociosos na sua agenda durante o expediente. Profissionalize sua precificação e ofereça uma jornada de escolha clara e direta para todos os seus clientes fidelizados.</p>
                            </div>
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            <span className="bg-pink-50 text-pink-600 p-3 rounded-2xl border border-pink-200/60 shrink-0 flex items-center justify-center text-2xl shadow-sm">
                                💅
                            </span>
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-pink-600 transition-colors">Sistema de Gestão para Salões de Beleza</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">A solução definitiva para centros de estética e beleza</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 1. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA com link personalizado, logo e capa.</h3>
                                <p className="mt-2 text-left text-slate-600">Destaque seu salão no mercado com uma presença digital sofisticada que reflete a qualidade dos seus serviços estéticos. O Kairós permite que você crie um link de agendamento exclusivo, totalmente personalizado com sua marca, cores e identidade visual única. Enquanto sistemas genéricos desvalorizam sua imagem, nossa plataforma eleva o status do seu negócio perante clientes que buscam sofisticação e profissionalismo. Garanta uma primeira impressão impecável e converta mais interessados em agendamentos confirmados hoje mesmo.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 2. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA com agendas individuais para cada profissional.</h3>
                                <p className="mt-2 text-left text-slate-600">Organize sua equipe de cabeleireiros, manicures e esteticistas com calendários independentes e sincronizados em tempo real. O Kairós oferece a flexibilidade necessária para gerenciar múltiplos profissionais simultaneamente, evitando conflitos de horários e garantindo uma recepção sempre organizada. Cada membro da equipe tem total clareza sobre sua grade diária, o que otimiza o fluxo de atendimento e aumenta a produtividade geral do salão. Domine a gestão do seu time com uma ferramenta intuitiva que simplifica o dia a dia da beleza.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 3. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA com personalização de serviços, valores e tempos.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 4. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA sem necessidade de cadastro ou download.</h3>
                                <p className="mt-2 text-left text-slate-600">Remova as barreiras que impedem suas clientes de agendar um serviço de forma rápida e espontânea pelo celular. O diferencial do Kairós é permitir o agendamento direto pelo navegador, eliminando a fadiga de baixar novos aplicativos ou criar contas com senhas complexas. Essa facilidade de acesso garante uma taxa de conversão muito superior, pois respeita a pressa e a conveniência que o público feminino moderno exige. Proporcione a jornada de agendamento mais fluida do mercado e mantenha sua cadeira de atendimento sempre ocupada.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 5. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA com agendamento finalizado em menos de 1 minuto.</h3>
                                <p className="mt-2 text-left text-slate-600">Ofereça a agilidade de um agendamento inteligente que pode ser concluído em menos de 60 segundos com total facilidade. Nossa interface foi projetada para ser intuitiva, permitindo que a cliente escolha o serviço, o profissional e o horário em poucos cliques certeiros. A velocidade de resposta do sistema Kairós reduz a desistência e posiciona seu salão como uma empresa moderna e focada na excelência tecnológica. Ganhe tempo na sua recepção e deixe que o sistema automatize o processo de marcação 24 horas por dia para você.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 6. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA com agenda que evita conflitos de horários.</h3>
                                <p className="mt-2 text-left text-slate-600">Acabe com o estresse de marcar duas clientes para o mesmo profissional no mesmo horário através da nossa trava de segurança automática. O Kairós monitora a disponibilidade em milissegundos, garantindo que cada agendamento seja exclusivo e livre de erros humanos comuns em agendas de papel. Essa precisão operacional preserva a imagem do seu salão e garante que a experiência da cliente seja impecável do início ao fim do atendimento. Tenha a segurança de uma gestão digital robusta que protege a organização do seu negócio de beleza.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-pink-500 rounded-full inline-block"></span> 7. SISTEMA DE GESTÃO PARA SALÕES DE BELEZA com fotos reais de cada profissional.</h3>
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            <span className="bg-cyan-50 text-cyan-600 p-3 rounded-2xl border border-cyan-200/60 shrink-0 flex items-center justify-center text-2xl shadow-sm">
                                🏥
                            </span>
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-cyan-600 transition-colors">Sistema de Gestão para Clínicas de Estética</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">Gestão de alta performance para saúde e bem-estar</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        ...
                        <div className="mt-14 flex justify-center md:justify-start">
                            <Link href="/cadastro" className="bg-cyan-600 text-white px-8 py-4 rounded-full font-bold hover:bg-cyan-700 transition-all shadow-md shadow-cyan-500/25 text-center text-sm md:text-base leading-snug">
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            <span className="bg-purple-50 text-purple-600 p-3 rounded-2xl border border-purple-200/60 shrink-0 flex items-center justify-center text-2xl shadow-sm">
                                🐉
                            </span>
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-purple-600 transition-colors">Sistema de Gestão para Studios de Tattoo</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">Organização e liberdade para artistas e tatuadores</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-purple-500 rounded-full inline-block"></span> 1. SISTEMA DE GESTÃO PARA STUDIOS DE TATTOO com link personalizado e branding artístico.</h3>
                                <p className="mt-2 text-left text-slate-600">Fortaleça a identidade visual do seu estúdio com um link de agendamento que respira arte e profissionalismo em cada detalhe. O Kairós permite que você personalize sua página de marcação com logo e capa exclusivos, criando uma vitrine digital que valoriza o seu estilo autoral antes mesmo da primeira agulhada. Em um mercado onde a imagem é tudo, ter um sistema de gestão para studios de tattoo organizado e esteticamente impecável separa os amadores dos artistas de elite. Garanta que a primeira interação do seu cliente seja tão impactante quanto o seu trabalho artístico final.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-purple-500 rounded-full inline-block"></span> 2. SISTEMA DE GESTÃO PARA STUDIOS DE TATTOO com agendas individuais para cada tatuador.</h3>
                                <p className="mt-2 text-left text-slate-600">Gerencie múltiplos artistas no mesmo estúdio com agendas independentes que respeitam o ritmo de trabalho e a disponibilidade de cada tatuador. Nossa plataforma permite que cada membro da equipe controle sua própria grade, eliminando confusões de horários e garantindo uma recepção muito mais tranquila. Essa autonomia é fundamental em studios de tattoo modernos, onde a organização individual reflete na produtividade coletiva do espaço. Tenha o controle total sobre quem está tatuando e quando, mantendo a harmonia operacional do seu estúdio de forma 100% digital e segura.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-purple-500 rounded-full inline-block"></span> 3. SISTEMA DE GESTÃO PARA STUDIOS DE TATTOO com personalização de sessões, valores e tempos.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-purple-500 rounded-full inline-block"></span> 7. SISTEMA DE GESTÃO PARA STUDIOS DE TATTOO com fotos reais de cada tatuador no agendamento.</h3>
                                <p className="mt-2 text-left text-slate-600">Humanize seu estúdio permitindo que o cliente identifique visualmente o tatuador de sua preferência através de fotos reais no momento do agendamento. Em um mercado movido pela conexão artística, visualizar o rosto do profissional gera uma camada extra de confiança e autoridade imediata. Esse recurso de branding pessoal ajuda a destacar o estilo de cada artista do estúdio, facilitando a escolha do cliente de acordo com a técnica desejada. Transforme seu link de agendamento em uma ferramenta poderosa de marketing visual que valoriza o time de talentos do seu studio de tattoo.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-purple-500 rounded-full inline-block"></span> 8. SISTEMA DE GESTÃO PARA STUDIOS DE TATTOO com dashboard intuitivo para os artistas.</h3>
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            <span className="bg-orange-50 text-orange-600 p-3 rounded-2xl border border-orange-200/60 shrink-0 flex items-center justify-center text-2xl shadow-sm">
                                🍽️
                            </span>
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-orange-600 transition-colors">Sistema de Gestão para Restaurantes</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">Controle total de reservas de mesas e fluxo de clientes</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-orange-500 rounded-full inline-block"></span> 7. SISTEMA DE GESTÃO PARA RESTAURANTES com fotos reais da equipe e ambiente no agendamento.</h3>
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            <span className="bg-indigo-50 text-indigo-600 p-3 rounded-2xl border border-indigo-200/60 shrink-0 flex items-center justify-center text-2xl shadow-sm">
                                📸
                            </span>
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-indigo-600 transition-colors">Sistema de Gestão para Estúdios de Fotografia</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">Agendamento de ensaios e sessões de forma profissional</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 1. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com link personalizado, logo e capa.</h3>
                                <p className="mt-2 text-left text-slate-600">Eleve a percepção de valor do seu trabalho artístico com uma interface de agendamento que funciona como uma extensão do seu portfólio profissional. O Kairós permite que você personalize seu link de reserva com sua marca e imagens de impacto, transmitindo autoridade imediata para clientes que buscam ensaios de alto nível. Ter um sistema de gestão para estúdios de fotografia organizado visualmente é fundamental para se destacar em um mercado movido pela estética e pelo profissionalismo. Garanta que a primeira interação digital do seu cliente seja tão impecável quanto a edição final das suas fotos.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 2. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com agendas individuais para cada fotógrafo da equipe.</h3>
                                <p className="mt-2 text-left text-slate-600">Gerencie sua equipe de fotógrafos e assistentes com calendários independentes que evitam o conflito de datas e garantem a organização total de múltiplos ensaios simultâneos. No Kairós, cada profissional possui sua própria grade de disponibilidade, permitindo uma gestão de escala fluida e extremamente eficiente para estúdios que atendem diversos nichos ao mesmo tempo. Essa autonomia técnica aumenta a produtividade do time e assegura que nenhum ensaio seja marcado fora dos critérios operacionais da sua marca. Domine a gestão operacional do seu estúdio com uma tecnologia que entende a dinâmica real do mercado fotográfico nacional.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 3. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com personalização de sessões, valores e tempos.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 4. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA sem necessidade de cadastro ou download para o cliente.</h3>
                                <p className="mt-2 text-left text-slate-600">Remova os obstáculos tecnológicos que impedem o seu cliente de reservar um ensaio de forma rápida e espontânea diretamente pelo celular. O diferencial do Kairós é permitir o agendamento sem a obrigatoriedade de baixar novos aplicativos ou criar contas complexas com senhas que o cliente acaba esquecendo. Essa facilidade extrema de acesso garante uma taxa de conversão muito superior, respeitando a conveniência e a pressa que o público moderno exige no meio digital. Proporcione a jornada de marcação mais fluida do mercado de fotografia e mantenha sua agenda de sessões sempre ocupada com praticidade absoluta.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 5. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com agendamento finalizado em menos de 1 minuto.</h3>
                                <p className="mt-2 text-left text-slate-600">Ofereça a agilidade de um agendamento inteligente que pode ser concluído em menos de 60 segundos com total facilidade para o seu público. Nossa interface foi projetada para ser intuitiva, permitindo que o cliente escolha o tipo de ensaio, o fotógrafo e o horário em poucos cliques certeiros e visuais. Velocidade no agendamento digital é um sinal de modernidade que eleva o status do seu estúdio perante um público que busca eficiência e profissionalismo. Automatize seu atendimento 24 horas por dia e deixe que o sistema trabalhe na captação de novos ensaios enquanto você foca na direção criativa das suas sessões.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 6. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com agenda inteligente que evita conflitos de datas.</h3>
                                <p className="mt-2 text-left text-slate-600">Acabe com o pesadelo de marcar dois ensaios externos no mesmo horário através da nossa trava de segurança automática que monitora sua disponibilidade em tempo real. O sistema Kairós atua como um assistente digital infalível, processando cada reserva em milissegundos para garantir que sua grade de horários seja impecável e livre de erros humanos. Evitar o choque de datas é vital para manter a credibilidade do fotógrafo e garantir que cada cliente receba a atenção e o tempo necessário para um resultado de excelência. Tenha a segurança de uma gestão digital robusta que protege a organização do seu estúdio de forma profissional.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 7. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com fotos reais da equipe no momento da reserva.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-indigo-500 rounded-full inline-block"></span> 8. SISTEMA DE GESTÃO PARA ESTÚDIOS DE FOTOGRAFIA com dashboard intuitivo para os fotógrafos.</h3>
                ...
                <details className="group border-b border-slate-200/80 cursor-pointer transition-all">
                    <summary className="flex items-center py-4 md:py-5 outline-none select-none hover:opacity-80 transition-opacity cursor-pointer">
                        <span className="flex items-center gap-4 md:gap-6">
                            <span className="bg-emerald-50 text-emerald-600 p-3 rounded-2xl border border-emerald-200/60 shrink-0 flex items-center justify-center text-2xl shadow-sm">
                                💼
                            </span>
                            <span className="flex flex-col text-left">
                                <span className="text-xl md:text-2xl font-black uppercase tracking-tight text-slate-900 leading-tight block group-hover:text-emerald-600 transition-colors">Sistema de Gestão para Serviços em Geral</span>
                                <span className="text-xs md:text-sm text-slate-500 uppercase tracking-widest mt-1 italic block font-medium">A solução universal para qualquer prestador de serviço</span>
                            </span>
                        </span>
                    </summary>
                    ...
                    <div className="py-8 md:py-12 relative">
                        <div className="grid grid-cols-1 gap-12 max-w-4xl relative z-10 text-slate-600 text-sm md:text-base leading-relaxed">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 1. SISTEMA DE GESTÃO PARA SERVIÇOS com link personalizado, logo e capa profissionais.</h3>
                                <p className="mt-2 text-left text-slate-600">Profissionalize sua presença digital com uma interface de agendamento que centraliza toda a sua demanda em um único link exclusivo e personalizado. O Kairós permite que você apresente sua marca com autoridade, utilizando sua logo e capa para criar uma vitrine de serviços impecável no ambiente online. Ter um sistema de gestão para serviços organizado é o primeiro passo para sair do amadorismo e conquistar clientes de alto valor que buscam eficiência e confiança. Garanta que seu link de agendamento seja a ferramenta de conversão mais potente do seu negócio digital hoje mesmo.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 2. SISTEMA DE GESTÃO PARA SERVIÇOS com agendas individuais para cada prestador de serviço.</h3>
                                <p className="mt-2 text-left text-slate-600">Gerencie sua equipe ou sua própria grade de horários com calendários independentes que eliminam qualquer risco de sobreposição de compromissos ou falhas de comunicação. Nossa plataforma oferece a flexibilidade necessária para múltiplos profissionais atuarem simultaneamente, garantindo uma organização fluida e extremamente profissional na sua recepção digital. Essa autonomia de gestão aumenta a produtividade geral e assegura que cada atendimento seja realizado dentro do prazo estabelecido. Domine a organização operacional do seu negócio com uma tecnologia robusta desenhada para qualquer nicho de atuação.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 3. SISTEMA DE GESTÃO PARA SERVIÇOS com personalização máxima de valores, tempos e categorias.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 4. SISTEMA DE GESTÃO PARA SERVIÇOS sem necessidade de cadastro, login ou download chato.</h3>
                                <p className="mt-2 text-left text-slate-600">Remova as barreiras tecnológicas que impedem o seu cliente de contratar seu serviço de forma rápida e espontânea diretamente pelo navegador do celular. O diferencial do Kairós é permitir o agendamento instantâneo sem a obrigatoriedade de baixar novos aplicativos ou preencher formulários de cadastro extensos que geram desistência. Essa facilidade extrema de acesso garante uma taxa de conversão muito superior, respeitando a conveniência e a pressa que o público moderno exige no meio digital atual. Proporcione a jornada de marcação mais fluida do mercado nacional e mantenha sua agenda sempre preenchida com praticidade.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 5. SISTEMA DE GESTÃO PARA SERVIÇOS com agendamento finalizado em menos de 1 minuto.</h3>
                                <p className="mt-2 text-left text-slate-600">Ofereça a agilidade que o mercado de serviços exige, permitindo que seu cliente agende um horário em menos de 60 segundos com total facilidade e segurança. Nossa interface foi projetada para ser intuitiva e direta, removendo etapas burocráticas que apenas cansam o usuário e atrasam o processo de fechamento de novos negócios. Velocidade no agendamento digital é um sinal de modernidade e respeito ao tempo do cliente, características fundamentais para profissionais que buscam se destacar. Automatize seu atendimento 24 horas por dia e deixe que o sistema trabalhe na captação de novas vendas enquanto você foca na execução.</p>
                            </div>

                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 6. SISTEMA DE GESTÃO PARA SERVIÇOS com agenda inteligente que evita conflitos de horários.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 7. SISTEMA DE GESTÃO PARA SERVIÇOS com fotos reais de cada profissional no agendamento.</h3>
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 uppercase flex items-center gap-2"><span className="w-1 h-5 bg-emerald-500 rounded-full inline-block"></span> 8. SISTEMA DE GESTÃO PARA SERVIÇOS com dashboard intuitivo para gestão administrativa.</h3>
