    ...
    <div className="min-h-screen bg-gray-50 p-6 md:p-10 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            {/* Botões Futuros (Visuais apenas) */}
            <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 flex flex-col items-center justify-center gap-2 opacity-50 cursor-not-allowed">
                <span className="text-3xl">⚙️</span>
                <span className="font-bold text-gray-500">Configurar</span>
            </div>
             <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 flex flex-col items-center justify-center gap-2 opacity-50 cursor-not-allowed">
                <span className="text-3xl">📊</span>
                <span className="font-bold text-gray-500">Relatórios</span>
            </div>
        </div>
