        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-sm">Gerencie sua assinatura e dados da empresa.</p>
                    </div>
                </div>
                <div className={`px-4 py-2 rounded-full text-xs font-bold border ${statusColor} w-fit`}>
                    {statusLabel}
                </div>
            </div>
            ...
            <div className="bg-green-900/10 border border-green-800/30 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="bg-green-500/10 p-3 rounded-full text-green-500 shrink-0">
