...
// --- METADATA (SEO DE ALTA DENSIDADE PARA ARUJÁ) ---
export const metadata: Metadata = {
  title: "Sistema de Gestão e Agendamento em Arujá | Kairós",
  description: "O melhor sistema de gestão e agendamento online para negócios em Arujá. Automatize sua agenda via WhatsApp, controle seu financeiro e atenda o público de alto padrão com tecnologia de ponta. Teste grátis!",
  keywords:["sistema de gestão arujá", "agendamento online arujá", "software para barbearia arujá", "agenda salão de beleza arujá", "gestão de clínicas arujá", "automação comercial avenida amazonas", "sistema para pet shop arujá", "agendamento condomínio arujá"],
  alternates: {
    canonical: "https://kairos.egemporiodigital.com.br/sistema-de-gestao/aruja"
  },
  icons: {
    icon: "/logo.png",
    apple: "/logo.png",
...
// --- SCHEMA MARKUP GEO-NICHADO (OFERTA LOCAL ARUJÁ) ---
const jsonLd = {
  "@context": "https://schema.org",
  "@type": "SoftwareApplication",
  "name": "Kairós - Sistema de Gestão Arujá",
  ...
  "offers": {
    ...
    "price": "0",
    "priceCurrency": "BRL",
    "description": "Teste Grátis de 3 dias sem cartão para negócios em Arujá",
    "eligibleRegion": {
      "@type": "Place",
      "name": "Arujá, São Paulo, SP"
    }
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 md:gap-3">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-[9px] md:text-[10px] text-gray-400 font-medium tracking-wide uppercase">Arujá Exclusive Edition</span>
            </div>
          </Link>
      ...
      <main className="relative z-10">
        ...
        <section className="pt-40 pb-12 px-6 relative">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-md text-blue-400 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide border border-white/10 shadow-inner">
              <span>📍</span>
              <span>Gestão de Elite para o Comércio de Arujá</span>
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
              Em uma cidade que exige exclusividade e sofisticação, sua gestão precisa ser impecável. Automatize seu atendimento e ofereça a conveniência que o público de Arujá merece.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4">
              <Link href="/cadastro" className="w-full md:w-auto bg-white text-black px-8 py-4 rounded-full text-lg font-bold hover:bg-blue-50 transition-all shadow-[0_0_50px_-10px_rgba(255,255,255,0.4)] hover:-translate-y-1 flex items-center justify-center gap-2">
                Começar Teste Grátis em Arujá 🚀
              </Link>
            </div>
          </div>
        </section>

        {/* --- OS 30% EXCLUSIVO LOCAL (HOOK ARUJÁ) --- */}
        <section className="py-12 px-6">
            <div className="max-w-5xl mx-auto bg-[#080b11] border border-blue-900/30 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 uppercase tracking-wide">Arujá exige tecnologia com sofisticação e rapidez.</h2>
                <div className="space-y-4 text-gray-400 leading-relaxed text-sm md:text-base">
                    <p>
                        Se o seu negócio está localizado na movimentada <strong>Avenida Amazonas</strong>, no prestigiado polo comercial do <strong>Center Ville</strong> ou atende os moradores dos condomínios de alto padrão como o <strong>Arujá 5 e Hills</strong>, você sabe que o profissionalismo é o seu maior ativo.
                    </p>
                    <p>
                        O cliente de Arujá busca conveniência absoluta. Ele quer agendar um serviço enquanto está no condomínio ou a caminho de São Paulo, sem precisar esperar por uma resposta humana no WhatsApp. O <strong>Kairós</strong> foi desenvolvido para ser o cérebro do seu negócio, oferecendo um <strong>sistema de gestão</strong> completo que transforma seu link da bio em uma recepção digital 24 horas. Elimine falhas humanas, organize seu financeiro e ofereça a experiência premium que o público arujaense espera.
                    </p>
                </div>
            </div>
        </section>
        ...
        {/* --- O SEO ACCORDION TITÂNIO (12 PILARES DENSOS ARUJÁ) --- */}
                ...
                <details className="group bg-[#080b11] border border-blue-900/30 rounded-2xl shadow-2xl overflow-hidden cursor-pointer transition-all duration-300">
                        ...
                        <div className="flex items-center gap-4 md:gap-6">
                            ...
                            <div className="flex flex-col">
                                <h2 className="text-lg md:text-2xl font-bold uppercase tracking-wide text-white leading-tight">
                                    Tese de Autoridade: Sistema de Gestão em Arujá
                                </h2>
                                <p className="text-xs md:text-sm text-gray-500 uppercase tracking-widest mt-1">
                                    Estratégia de Alta Performance para o Comércio de Arujá
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="px-6 md:px-12 py-10 bg-[#030407] border-t border-white/5 relative">
                        ...
                        <p className="text-gray-400 leading-relaxed mb-12 text-sm md:text-base max-w-4xl relative z-10">
                            No comércio de alto padrão de Arujá, a agilidade e a exclusividade definem o sucesso. O <strong>Kairós</strong> entrega 12 pilares fundamentais de tecnologia, garantindo que o seu negócio opere com a máxima eficiência operacional e controle absoluto de faturamento.
                        </p>
                        ...
                        <div className="flex flex-col gap-10 max-w-4xl relative z-10">
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">1. Sistema de Gestão para Barbearias em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Para as barbearias premium localizadas na <strong>Avenida Amazonas</strong> ou próximas aos condomínios Hills, a organização é essencial. Nosso <strong>sistema de gestão para barbearias</strong> permite que o cliente agende cortes em segundos via link. Você controla as comissões dos barbeiros automaticamente, gerencia o estoque de produtos e monitora o faturamento diário em tempo real, garantindo uma recepção livre de filas e um caixa impecável.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">2. Sistema de Gestão para Salões de Beleza em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Gerenciar um salão de beleza em Arujá exige precisão absoluta com horários. O <strong>sistema de gestão para salão de beleza</strong> do Kairós organiza agendas individuais para cada profissional, enviando lembretes automáticos via WhatsApp para as clientes. Isso reduz drasticamente o número de faltas e profissionaliza o fluxo de caixa, permitindo que você foque no atendimento de luxo.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">3. Sistema de Gestão para Clínicas e Consultórios em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Para os consultórios médicos e estéticos no <strong>Center Ville</strong>, a pontualidade transmite confiança. Com nosso <strong>sistema de gestão para clínicas</strong>, o paciente realiza o agendamento de consultas de forma autônoma e silenciosa. O software centraliza o histórico de marcações e profissionaliza o atendimento da recepção, refletindo o alto padrão de cuidado que seu negócio oferece em Arujá.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">4. Sistema de Gestão para Restaurantes (Reservas em Arujá)</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Aproveite o crescimento gastronômico de Arujá com gestão profissional. Nosso <strong>sistema de gestão para restaurantes</strong> permite que seus clientes reservem mesas online de forma rápida. Isso evita filas desordenadas na porta, organiza o salão para horários de pico e permite que sua equipe esteja preparada para a demanda real da elite local.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">5. Sistema de Gestão para Studios de Tattoo em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Sessões de tatuagem longas exigem um controle de pauta cirúrgico. Com o <strong>sistema de gestão para tatuadores</strong> em Arujá, seu estúdio pode organizar blocos de horários para artes complexas e orçamentos rápidos. O cliente envia referências direto no ato da reserva, você organiza sua agenda de forma visual e mantém a gestão financeira totalmente transparente.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">7. Sistema de Gestão para Autônomos em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Seja para pet shops premium em Arujá, serviços de estética automotiva ou personal trainers. Se o seu modelo de negócio vende horas de serviço, nosso <strong>sistema de gestão</strong> é a ferramenta certa. Ele organiza sua semana, centraliza pagamentos e gera um link profissional que substitui a necessidade de sites complexos.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">8. Sistema de Gestão com Agendamento 24 Horas em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    O público de Arujá valoriza o tempo, e sua agenda não deveria fechar. Com este <strong>sistema de gestão</strong>, o cliente agenda às 23h voltando de São Paulo, visualiza sua disponibilidade real e confirma o horário instantaneamente. Pare de perder faturamento; deixe sua recepção digital trabalhar e faturar por você 24 horas por dia.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Elimine de vez o ciclo improdutivo de "qual horário fica melhor?" pelo WhatsApp em Arujá. O <strong>sistema de gestão</strong> Kairós oferece um painel visual intuitivo onde o cliente escolhe o serviço e o horário em segundos. Isso economiza horas de atendimento repetitivo e profissionaliza a sua marca local.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">10. Sistema de Gestão Financeira para Negócios em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Para negócios com vários colaboradores em Arujá, o controle financeiro é o pilar do lucro. Nosso <strong>sistema de gestão</strong> gerencia agendas da equipe, emite relatórios de comissões automáticos e mantém seu fluxo de caixa transparente. Tenha acesso a dados sobre ticket médio e performance em tempo real no seu painel.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">11. Sistema de Gestão Mobile-First (Otimizado para Arujá)</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Sua gestão precisa ser tão móvel quanto a rotina de quem vive em Arujá. Nossa arquitetura opera 100% em nuvem e é otimizada para smartphones. Gerencie seu <strong>sistema de gestão</strong> pelo celular de qualquer lugar. Interface intuitiva, carregamento ultra-rápido e controle total na palma da mão.
                                </p>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-1.5 h-6 bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                                    <h3 className="text-base md:text-lg font-bold text-white uppercase tracking-wide">12. Sistema de Gestão White-label com Teste Grátis em Arujá</h3>
                                </div>
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Sua autoridade local em Arujá é reforçada por uma tecnologia que carrega sua própria marca. O <strong>sistema de gestão</strong> Kairós permite customização básica para que a página de agendamento seja uma extensão do seu negócio. Experimente nossa plataforma por 3 dias de forma gratuita, sem necessidade de cartão de crédito.
                                </p>
                            </div>
                        ...
                        <div className="mt-14 flex justify-center md:justify-start relative z-10">
                            <Link href="/cadastro" className="bg-blue-600 text-white px-8 py-4 rounded-full text-base md:text-lg font-bold hover:bg-blue-700 transition-all shadow-[0_0_30px_-5px_rgba(37,99,235,0.4)]">
                                Iniciar Teste Gratuito em Arujá
                            </Link>
                        </div>
        ...
        <section className="py-24 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-white">Domine Arujá Digitalmente</h2>
              <p className="text-gray-400">Transforme acessos em faturamento real no comércio local.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-[#080b11] border border-blue-900/30 p-8 rounded-2xl text-center hover:border-pink-500 transition-all group hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Instagram Exclusive</h3>
                <p className="text-sm text-gray-400">O público de Arujá é extremamente visual. Tenha seu link Kairós na bio e use o Instagram para mostrar o alto padrão do seu atendimento.</p>
              </div>
              ...
              <div className="bg-[#080b11] border border-blue-900/30 p-8 rounded-2xl text-center hover:border-green-500 transition-all group hover:-translate-y-2">
                ...
                <p className="text-sm text-gray-400">Configure sua saudação: "Olá! Para agendar agora em nossa unidade Arujá, clique aqui e escolha seu horário: [Link da Agenda]".</p>
              </div>
              ...
              <div className="bg-[#080b11] border border-blue-900/30 p-8 rounded-2xl text-center hover:border-blue-500 transition-all group hover:-translate-y-2">
                <div className="text-3xl mb-4">📍</div>
                <h3 className="text-xl font-bold text-white mb-2">Google Maps Arujá</h3>
                <p className="text-sm text-gray-400">Apareça no topo das buscas do Google Maps em Arujá com um botão de agendamento direto e receba clientes dos melhores bairros.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-gradient-to-t from-black to-[#050505] border-t border-white/5">
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <p className="text-gray-400 mb-10 max-w-2xl mx-auto">
                    Acompanhe sua agenda de Arujá em tempo real, de qualquer lugar. Instale o Kairós na tela inicial em menos de 10 segundos.
                </p>
        ...
        <footer className="bg-black/80 backdrop-blur-xl py-12 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-sm text-gray-600">
              © 2025 Kairós - Sistema de Gestão Arujá.
            </div>
          </div>
        </footer>
