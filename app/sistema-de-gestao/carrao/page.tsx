...
// --- METADATA (SEO DE ALTA DENSIDADE PARA O CARRÃO) ---
export const metadata: Metadata = {
  title: "Sistema de Gestão e Agendamento no Carrão | Kairós",
  description: "O melhor sistema de gestão e agendamento online para negócios no Carrão. Automatize sua agenda via WhatsApp, controle seu financeiro e reduza faltas na Zona Leste. Teste grátis!",
  keywords:["sistema de gestão carrão", "agendamento online carrão", "software para barbearia vila carrao", "agenda salão de beleza carrão", "gestão de clínicas conselheiro carrão", "automação comercial zona leste"],
  alternates: {
    canonical: "https://kairos.egemporiodigital.com.br/sistema-de-gestao/carrao"
  },
  icons: {
    icon: "/logo.png",
    apple: "/logo.png",
...
// --- SCHEMA MARKUP GEO-NICHADO (OFERTA LOCAL CARRÃO) ---
const jsonLd = {
  "@context": "https://schema.org",
  "@type": "SoftwareApplication",
  "name": "Kairós - Sistema de Gestão Carrão",
  ...
  "offers": {
    ...
    "price": "0",
    "priceCurrency": "BRL",
    "description": "Teste Grátis de 3 dias sem cartão para negócios no bairro do Carrão",
    "eligibleRegion": {
      "@type": "Place",
      "name": "Carrão, São Paulo, SP"
    }
  }
}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 md:gap-3">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-[9px] md:text-[10px] text-gray-400 font-medium tracking-wide uppercase">Carrão Edition</span>
            </div>
          </Link>
      ...
      <main className="relative z-10">
        ...
        <section className="pt-40 pb-12 px-6 relative">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
              Na Zona Leste que mais cresce, o tempo é o seu ativo mais valioso. Automatize sua agenda, elimine o vaivém do WhatsApp e fature mais.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4">
              <Link href="/cadastro" className="w-full md:w-auto bg-white text-black px-8 py-4 rounded-full text-lg font-bold hover:bg-blue-50 transition-all shadow-[0_0_50px_-10px_rgba(255,255,255,0.4)] hover:-translate-y-1 flex items-center justify-center gap-2">
                Começar Teste Grátis no Carrão 🚀
              </Link>
            </div>
          </div>
        </section>

        {/* --- OS 30% EXCLUSIVO LOCAL (HOOK CARRÃO) --- */}
        <section className="py-12 px-6">
            <div className="max-w-5xl mx-auto bg-[#080b11] border border-blue-900/30 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 uppercase tracking-wide">O Carrão mudou, e a gestão do seu negócio também precisa mudar.</h2>
                <div className="space-y-4 text-gray-400 leading-relaxed text-sm md:text-base">
                    <p>
                        Se o seu negócio está localizado no coração da <strong>Avenida Conselheiro Carrão</strong>, nas imediações da <strong>Rua Taubaté</strong> ou próximo ao shopping Aricanduva, você está no epicentro de uma transformação comercial. 
                    </p>
                    <p>
                        Negócios na Vila Carrão perdem faturamento todos os meses porque o atendimento ainda é feito de forma analógica. O cliente moderno, que agora habita os novos prédios de alto padrão do bairro, não quer esperar 10 minutos por uma resposta no WhatsApp. Ele quer clicar e agendar. O <strong>Kairós</strong> entrega essa agilidade, oferecendo um <strong>sistema de gestão</strong> completo que trabalha 24h por dia para garantir que sua marca seja a primeira escolha na Zona Leste.
                    </p>
                </div>
            </div>
        </section>
        ...
        {/* --- O SEO ACCORDION TITÂNIO (12 PILARES DENSOS CARRÃO) --- */}
                ...
                <details className="group bg-[#080b11] border border-blue-900/30 rounded-2xl shadow-2xl overflow-hidden cursor-pointer transition-all duration-300">
                        ...
                        <div className="flex items-center gap-4 md:gap-6">
                            ...
                            <div className="flex flex-col">
                                <h2 className="text-lg md:text-2xl font-bold uppercase tracking-wide text-white leading-tight">
                                    Tese de Autoridade: Sistema de Gestão no Carrão
                                </h2>
                                <p className="text-xs md:text-sm text-gray-500 uppercase tracking-widest mt-1">
                                    Estratégia de Performance para Negócios da Zona Leste
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="px-6 md:px-12 py-10 bg-[#030407] border-t border-white/5 relative">
                        ...
                        <p className="text-gray-400 leading-relaxed mb-12 text-sm md:text-base max-w-4xl relative z-10">
                            No comércio pulsante do Carrão, o tempo de resposta é o que separa o lucro do prejuízo. O <strong>Kairós</strong> entrega 12 pilares fundamentais de tecnologia, garantindo que o seu negócio na Zona Leste opere com a máxima eficiência operacional e controle total de resultados.
                        </p>
                        ...
                        <div className="flex flex-col gap-10 max-w-4xl relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Aproveite o boom gastronômico do Carrão com gestão profissional. Nosso <strong>sistema de gestão para restaurantes</strong> permite que seus clientes reservem mesas online de forma rápida. Isso evita filas desordenadas na porta, organiza o salão para horários de pico e permite que sua equipe esteja preparada para a demanda real. Melhore a experiência do seu cliente e tenha controle total sobre a ocupação do seu estabelecimento, aumentando o giro de mesas com inteligência.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Sessões de tatuagem longas exigem um controle de pauta cirúrgico. Com o <strong>sistema de gestão para tatuadores</strong>, seu estúdio no Carrão pode organizar blocos de horários para artes complexas e agendamentos rápidos para orçamentos. O cliente envia referências direto no ato da reserva, você organiza sua agenda de forma visual e mantém a gestão financeira do estúdio totalmente transparente, separando custos de lucro real.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Seja para pet shops na <strong>Rua Taubaté</strong>, serviços de estética automotiva ou escolas de idiomas no Carrão. Se o seu modelo de negócio vende horas de serviço, nosso <strong>sistema de gestão para serviços</strong> é a ferramenta certa. Ele organiza sua semana, centraliza pagamentos e gera um link profissional que substitui a necessidade de sites complexos, garantindo que você tenha um fluxo constante de clientes agendados.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    O público do Carrão não para, e sua agenda também não deveria. Com este <strong>sistema de gestão</strong>, o cliente agendar às 23h voltando do trabalho ou no intervalo da faculdade, visualiza sua disponibilidade real e confirma o horário instantaneamente. Pare de perder dinheiro nos momentos de descanso; deixe sua recepção digital trabalhar e faturar por você 24 horas por dia, 7 dias por semana.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Para negócios com vários colaboradores no Carrão, o controle financeiro é o alicerce do crescimento. Nosso <strong>sistema de gestão</strong> gerencia as agendas de toda a equipe, emite relatórios de comissões automáticos e mantém seu fluxo de caixa transparente. Tenha acesso a dados sobre ticket médio e performance profissional em tempo real, permitindo decisões estratégicas baseadas em números reais.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Sua gestão precisa ser tão móvel quanto a rotina da Zona Leste. Nossa arquitetura opera 100% em nuvem e é otimizada para smartphones. Gerencie seu <strong>sistema de gestão</strong> pelo celular enquanto se desloca entre um atendimento e outro. Interface intuitiva, carregamento ultra-rápido e controle total na palma da mão, sem a necessidade de um computador fixo na recepção da sua loja ou clínica.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                                    Sua autoridade local é reforçada por uma tecnologia que carrega sua própria marca. O <strong>sistema de gestão</strong> Kairós permite customização básica para que a página de agendamento seja uma extensão do seu negócio no Carrão. Experimente nossa plataforma por 3 dias completos de forma gratuita, sem necessidade de cartão de crédito, e veja na prática como a automação vai transformar seu lucro.
                                </p>
                            </div>
                        ...
                        <div className="mt-14 flex justify-center md:justify-start relative z-10">
                            <Link href="/cadastro" className="bg-blue-600 text-white px-8 py-4 rounded-full text-base md:text-lg font-bold hover:bg-blue-700 transition-all shadow-[0_0_30px_-5px_rgba(37,99,235,0.4)]">
                                Iniciar Teste Gratuito no Carrão
                            </Link>
                        </div>
        ...
        <section className="py-24 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-white">Domine o Carrão Digitalmente</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-[#080b11] border border-blue-900/30 p-8 rounded-2xl text-center hover:border-pink-500 transition-all group hover:-translate-y-2">
                ...
                <p className="text-sm text-gray-400">O público da ZL é visual. Tenha seu link Kairós sempre disponível na bio e nos stories para converter seguidores em clientes reais.</p>
              </div>
              ...
              <div className="bg-[#080b11] border border-blue-900/30 p-8 rounded-2xl text-center hover:border-green-500 transition-all group hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Whats Business</h3>
                <p className="text-sm text-gray-400">Configure no Carrão: "Olá! Para agendar agora em nossa unidade, clique aqui: [Link da Agenda]".</p>
              </div>
              ...
              <div className="bg-[#080b11] border border-blue-900/30 p-8 rounded-2xl text-center hover:border-blue-500 transition-all group hover:-translate-y-2">
                ...
                <p className="text-sm text-gray-400">Apareça no topo das buscas do Google Maps no Carrão com um botão de agendamento direto pelo seu perfil.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-gradient-to-t from-black to-[#050505] border-t border-white/5">
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                <p className="text-gray-400 mb-10 max-w-2xl mx-auto">
                    Acompanhe sua agenda do Carrão em tempo real, de qualquer lugar. Instale o Kairós na tela inicial em menos de 10 segundos.
                </p>
        ...
        <footer className="bg-black/80 backdrop-blur-xl py-12 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-sm text-gray-600">
              © 2025 Kairós - Sistema de Gestão Carrão.
            </div>
          </div>
        </footer>
